...
describe('JsonldGraph', () => {
    ...
    describe('.getIncoming', () => {
        ...
        it('should throw when label is null, empty or undefined', () => {
            expect(() => graph.getIncoming(null as any)).to.throw(ReferenceError); 
            expect(() => graph.getIncoming('' as any)).to.throw(ReferenceError); 
            expect(() => graph.getIncoming(undefined as any)).to.throw(ReferenceError); 
        });

        it('should return all vertices with incoming edge', () => {
            const vertices = [...graph.getIncoming('urn:test:edge:1')];
    ...
    describe('.getOutgoing', () => {
        ...
        it('should throw when label is null, empty or undefined', () => {
            expect(() => graph.getOutgoing(null as any)).to.throw(ReferenceError);
            expect(() => graph.getOutgoing('')).to.throw(ReferenceError);
            expect(() => graph.getOutgoing(undefined as any)).to.throw(ReferenceError);
        });

        it('should return all outgoing vertices', () => {
            const vertices = [...graph.getOutgoing('i:edge:1')];
            expect(vertices.length).to.equal(2);
    ...
    describe('.removeEdge', () => {
        ...
        it('should throw when edge is null or undefined', () => {
            expect(() => graph.removeEdge(null)).to.throw(ReferenceError);
            expect(() => graph.removeEdge(undefined)).to.throw(ReferenceError);
        });
        ...
        it('should remove edge and all incoming and outgoing refereces', () => {
            ...
            expect(graph.getOutgoing(edge.label).count()).to.equal(0);
            expect(graph.getIncoming(edge.label).count()).to.equal(0);
        });
    });
    ...
    describe('.removeVertex', () => {
        ...
        it('should throw when vertex is null, undefined or empty', () => {
            expect(() => graph.removeVertex(null)).to.throw(ReferenceError);
            expect(() => graph.removeVertex(undefined)).to.throw(ReferenceError);
        ...
        it('should remove vertex instance and all edges', () => {
            ...
            expect(graph.getOutgoing('i:edge:1').count()).to.equal(0);
            expect(graph.getIncoming('i:edge:1').count()).to.equal(0);
            expect(graph.getOutgoing('i:edge:2').count()).to.equal(1);
            expect(graph.getIncoming('i:edge:2').count()).to.equal(1);
        });
    });
    ...
    describe('.removePrefix', () => {
        ...
        it('should throw when preix is null, empty or undefined', () => {
            expect(() => graph.removePrefix(null)).to.throw(ReferenceError);
            expect(() => graph.removePrefix(undefined)).to.throw(ReferenceError);
